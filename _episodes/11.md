...
In [episode five](/episodes/5.html), we spoke about Hive partitions. 
...
In episode [six](/episodes/6.html) and [seven](/episodes/7.html),
...
In episode [nine](/episodes/9.html), we discussed how hash-joins work
...
answers the query. We can look at [the blog written for the original local
 dynamic filtering implementation](/blog/2019/06/30/dynamic-filtering.html)
...
seen in [Raunaq's blog about dynamic partition pruning](/blog/2020/06/14/dynamic-partition-pruning.html)
